    ...
    fetch(`/Home/QuickView?productId=${productId}`, {
        ...
        .catch(error => {
            ...
            <div class="alert alert-danger">
                <h5><i class="fa fa-exclamation-triangle me-2"></i>Failed to load product details</h5>
                <p>${error.message || 'There was an error loading the product information. Please try again later.'}</p>
                <button class="btn btn-outline-primary mt-2" onclick="quickView(${productId})">
