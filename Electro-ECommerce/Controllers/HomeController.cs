    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> QuickView(int productId)
        {
            try
            {
                ...
                // Return the partial view with the product model
                return PartialView("~/Views/Shared/_QuickViewModal.cshtml", product);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error in QuickView action for product ID: {ProductId}", productId);
                return StatusCode(500, "An error occurred while loading the product details.");
            }
        }

        public IActionResult TestQuickView(int id)
        {
            ...
            return View("~/Views/Shared/_QuickViewModal.cshtml", product);
        }
